...
- **Idle RAM** ≥ 150 MB baseline. Tier-1 NFR-Performance is ≤ 300 MB *per idle persona* — Electron would consume half that budget on the shell alone.
