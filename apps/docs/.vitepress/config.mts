...
export default defineConfig({
  ...
  themeConfig: {
    ...
    sidebar: {
      ...
      "/first-run/": [{ text: "First Run Wizard", link: "/first-run/" }],
      "/getting-started/": [
      ...
      "/bmad/": [{ text: "BMAD Workflows", link: "/bmad/" }],
      "/multi-machine/": [{ text: "Multi-Machine Setup", link: "/multi-machine/" }],
      "/troubleshooting/": [{ text: "Troubleshooting", link: "/troubleshooting/" }],
    },
    socialLinks: [{ icon: "github", link: "https://github.com/Code4neverCompany/4neverCompanyOS" }],
  },
});
