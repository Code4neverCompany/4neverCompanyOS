  ...
  return (
    <div className="step welcome-step">
      ...
      <p className="step-help">
        This wizard does not send your credentials anywhere. Anthropic keys go into Claude Code's
        own credential store. The workspace never sees or proxies the actual secret values.
      </p>
