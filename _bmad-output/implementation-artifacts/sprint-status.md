...
| 1.16  | Hermes TUI embedded as a pane              | 🟡 In progress  | —                               | Architecture decision in progress (Winston pass) — three options laid out in the story file; awaiting Maurice's scope confirmation.  |
