...
| 1.16  | Hermes TUI embedded as a pane              | 🟡 In progress  | —                               | Architecture corrected via bmad-correct-course (Winston pass rev 2): Zellij-owned spawn + supervisor PTY tap + xterm.js display layer. Three sub-stories: 1.16a (supervisor PTY upgrade) + 1.16b (Hermes spawn) + 1.16c (xterm.js frontend + tail bridge). |
